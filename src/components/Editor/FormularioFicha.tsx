...
const TIPO_LABELS: Record<SecaoTipo, string> = {
  ...
  fluxo: 'Fluxos, tabelas e imagens grandes',
};

/* Tipos visíveis no dropdown (removendo lista, tabela, callout) */
const TIPOS_VISIVEIS: SecaoTipo[] = ['h2', 'h3', 'h4', 'h5', 'paragrafo', 'imagem', 'destaque', 'fluxo'];
    ...
    <div className="border border-gray-300 rounded-sm p-4 bg-medway-light/20 space-y-3">
      ...
      <div>
        ...
        >
          ...
          <option value="fluxo">Fluxos, tabelas e imagens grandes</option>
        </select>
      </div>
      ...
      {secao.tipo === 'fluxo' && (
        <div className="space-y-3">
          {/* badge indicativo */}
          <p className="text-xs text-medway-gray italic">
            Esta seção ocupa a largura total da página (fora das 2 colunas).
          </p>
